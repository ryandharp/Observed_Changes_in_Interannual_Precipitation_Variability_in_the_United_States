...
def wrapper(domain):
    ...
    results_df.to_csv('/home/rdh0715/interannual_variability_results/AR_results/NEON_domain_precip_stats_start_year_' + str(begin_year) + '_window_length_' + str(window_length) + '_domain_' + str(domain) + '_AR2.csv')

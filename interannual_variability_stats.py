...
# to do: set standard begin year (then do sensitivity: 1950)
# to do: do a sensitivity analysis on the window_length (8 to 15?)
# to do: loosen station restrictions
...
def wrapper(domain):
    ...
    # annual mean
    region_annual_mean_p[domain-1], region_annual_mean_slope[domain-1] = region_mannkendall(domain_annual_mean_df)
    ...
    # annual frequency
    region_annual_freq_p[domain-1], region_annual_freq_slope[domain-1] = region_mannkendall(domain_annual_freq_df)
    region_annual_freq[domain-1] = domain_annual_freq_df.mean(axis=0).mean()
    domain_num_stations[domain-1] = num_domain_stations

    # print(region_annual_mean_p)
    # print(region_annual_mean_slope)
    # print(region_annual_var_p)
    # print(region_annual_var_slope)
    # print(region_annual_cov_p)
    # print(region_annual_cov_slope)
    # print(region_annual_freq_p)
    # print(region_annual_freq_slope)
    ...
    results_df.to_csv('/home/rdh0715/interannual_variability_results/NEON_domain_precip_stats_start_year_' + str(begin_year) + '_window_length_' + str(window_length) + '_domain_' + str(domain) + '_AR.csv')

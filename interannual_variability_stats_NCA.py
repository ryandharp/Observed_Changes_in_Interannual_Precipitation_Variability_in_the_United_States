...
#%% Printing Test Results
    ...
    region_annual_var_p[domain-1], region_annual_var_slope[domain-1] = region_mannkendall(domain_annual_precip_var_df)
    region_annual_var[domain-1] = domain_annual_precip_var_df.mean(axis=0).mean()
    region_annual_cov_p[domain-1], region_annual_cov_slope[domain-1] = region_mannkendall(domain_annual_precip_cov_df)
...
if __name__ == '__main__':
    ...
    pool.map(wrapper, np.arange(1, 11, 1))
